...
def create_colorbar(fig, ax, mapp, array_of_values, valfmt="{x:.2f}", fontdict_cbar_label=None,
                    fontdict_cbar_tickslabel=None, fontdict_cbar_ticks=None, position='bottom'):
...
def set_ticks_label(ax, ax_type, data, num=5, valfmt="{x:.2f}", ticks=None, only_ticks=False, tick_lab=None,
    ...
    if scale == 'log':
        ...
        if ax_type == 'x':
            ...
            ax.set_xlabel(ax_label, labelpad=label_pad, fontdict=fontdict_label_standard)
        elif ax_type == 'y':
            ax.set_yticks(ticks)
            ax.set_yticklabels(tick_lab, fontdict=fontdict_ticks_label_standard)
            ax.set_ylabel(ax_label, labelpad=label_pad, fontdict=fontdict_label_standard)
        elif ax_type == 'z':
            ax.set_zticks(ticks)
            ax.set_zticklabels(tick_lab, fontdict=fontdict_ticks_label_standard)
            ax.set_zlabel(ax_label, labelpad=label_pad, fontdict=fontdict_label_standard)
        else:
            'non-valid ax_type: x, y, z'
